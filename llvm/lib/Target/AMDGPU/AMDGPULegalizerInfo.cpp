        ...
        .fewerElementsIf(
            ...
            [=](const LegalityQuery &Query) -> std::pair<unsigned, LLT> {
              ...
              if (MemSize > MaxSize) {
                ...
                if (unsigned EltSize = EltTy.getSizeInBits(); MaxSize % EltSize == 0) {
                  return std::pair(
...
bool AMDGPULegalizerInfo::legalizeExtractVectorElt(
  ...
  if (const uint64_t IdxVal = MaybeIdxVal->Value.getZExtValue(); IdxVal < VecTy.getNumElements()) {
...
bool AMDGPULegalizerInfo::legalizeInsertVectorElt(
  ...
  if (unsigned NumElts = VecTy.getNumElements(); IdxVal < NumElts) {
