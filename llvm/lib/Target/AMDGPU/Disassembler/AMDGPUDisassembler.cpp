...
#define PRINT_DIRECTIVE(DIRECTIVE, MASK)                                       \
  ...
  switch (DataExtractor DE(Bytes, /*IsLittleEndian=*/true, /*AddressSize=*/8); Cursor.tell()) {
...
Expected<bool> AMDGPUDisassembler::onSymbolStart(SymbolInfoTy &Symbol,
  ...
  if (StringRef Name = Symbol.Name; Symbol.Type == ELF::STT_OBJECT && Name.ends_with(StringRef(".kd"))) {
