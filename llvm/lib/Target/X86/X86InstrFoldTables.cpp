...
struct X86BroadcastFoldTable {
  ...
  X86BroadcastFoldTable() {
    ...
    for (const X86FoldTableEntry &Reg2Bcst : BroadcastTable2) {
      ...
      if (const X86FoldTableEntry *unsigned BcstOp = Reg2Bcst.DstOp; Reg2Mem = lookupFoldTable(RegOp, 2)) {
    ...
    for (const X86FoldTableEntry &Reg2Bcst : BroadcastTable3) {
      ...
      if (const X86FoldTableEntry *unsigned BcstOp = Reg2Bcst.DstOp; Reg2Mem = lookupFoldTable(RegOp, 3)) {
        unsigned MemOp = Reg2Mem->DstOp;
        uint16_t Flags =
    ...
    for (const X86FoldTableEntry &Reg2Bcst : BroadcastTable4) {
      ...
      if (const X86FoldTableEntry *unsigned BcstOp = Reg2Bcst.DstOp; Reg2Mem = lookupFoldTable(RegOp, 4)) {
        unsigned MemOp = Reg2Mem->DstOp;
        uint16_t Flags =
