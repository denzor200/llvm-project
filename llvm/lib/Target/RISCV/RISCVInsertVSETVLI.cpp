...
static unsigned computeVLMAX(unsigned VLEN, unsigned SEW,
  ...
  if (auto [LMul, Fractional] = RISCVVType::decodeVLMUL(VLMul); Fractional)
    VLEN = VLEN / LMul;
  else
    VLEN = VLEN * LMul;
  return VLEN/SEW;
...
void RISCVInsertVSETVLI::transferBefore(VSETVLIInfo &Info,
  ...
  if (bool EquallyZero = IncomingInfo.hasEquallyZeroAVL(PrevInfo, LIS) &&
                     IncomingInfo.hasSameVLMAX(PrevInfo); Demanded.VLAny || (Demanded.VLZeroness && !EquallyZero))
