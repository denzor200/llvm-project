...
void RISCVISAInfo::printEnabledExtensions(
  ...
  if (auto unsigned XLen = IsRV64 ? 64 : 32; ISAString = RISCVISAInfo::createFromExtMap(XLen, FullExtMap))
...
RISCVISAInfo::parseArchString(StringRef Arch, bool EnableExperimentalExtension,
  ...
  if (Arch.consume_front("rv32")) {
    ...
    if (FoundProfile) {
      ...
      if (StringRef ArchWithoutProfile = Arch.drop_front(I->Name.size()); !ArchWithoutProfile.empty()) {
