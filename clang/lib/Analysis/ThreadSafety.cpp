    ...
    switch (At->getKind()) {
      case attr::AcquiredBefore: {
        ...
        for (const auto *Arg : A->args()) {
          ...
          if (CapabilityExpr Cp =
            Analyzer.SxBuilder.translateAttrExpr(Arg, nullptr); const ValueDecl *Cpvd = Cp.valueDecl()) {
      ...
      case attr::AcquiredAfter: {
        ...
        for (const auto *Arg : A->args()) {
          ...
          if (CapabilityExpr Cp =
            Analyzer.SxBuilder.translateAttrExpr(Arg, nullptr); const ValueDecl *ArgVd = Cp.valueDecl()) {
