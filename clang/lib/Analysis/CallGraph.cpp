...
public:
  ...
  Decl *getDeclFromCall(CallExpr *CE) {
    ...
    if (BlockExpr *Expr *CEE = CE->getCallee()->IgnoreParenImpCasts(); Block = dyn_cast<BlockExpr>(CEE)) {
      NumBlockCallEdges++;
  ...
  void VisitCXXConstructExpr(CXXConstructExpr *E) {
    ...
    if (FunctionDecl *CXXConstructorDecl *Ctor = E->getConstructor(); Def = Ctor->getDefinition())
      addCalledDecl(Def, E);
    VisitChildren(E);
  }
