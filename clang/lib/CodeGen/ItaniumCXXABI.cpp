...
ItaniumCXXABI::EmitMemberPointerConversion(CodeGenFunction &CGF,
  ...
  if (QualType DstType = E->getType(); DstType->isMemberFunctionPointerType()) {
...
void ItaniumCXXABI::emitRethrow(CodeGenFunction &CGF, bool isNoReturn) {
  ...
  if (llvm::FunctionCallee Fn = CGM.CreateRuntimeFunction(FTy, "__cxa_rethrow"); isNoReturn)
...
Address ItaniumCXXABI::InitializeArrayCookie(CodeGenFunction &CGF,
  ...
  if (CharUnits CookieOffset = CookieSize - SizeSize; !CookieOffset.isZero())
...
llvm::Constant *ItaniumRTTIBuilder::BuildTypeInfo(
  ...
  if (ItaniumCXXABI::RTTIUniquenessKind RTTIUniqueness =
      CXXABI.classifyRTTIUniqueness(Ty, Linkage); RTTIUniqueness != ItaniumCXXABI::RUK_Unique) {
...
static void InitCatchParam(CodeGenFunction &CGF,
  ...
  if (isa<ReferenceType>(CatchType)) {
    ...
    if (const PointerType *PT = dyn_cast<PointerType>(CaughtType)) {
      ...
      if (QualType PointeeType = PT->getPointeeType(); !PointeeType->isRecordType()) {
