...
void Generic_GCC::GCCInstallationDetector::init(
  ...
  if (std::string TripleNoVendor, BiarchTripleNoVendor; TargetTriple.getVendor() == llvm::Triple::UnknownVendor) {
  ...
  if (const Arg *A = Args.getLastArg(options::OPT_gcc_install_dir_EQ);
    ...
    if (StringRef InstallDir = A->getValue(); !ScanGCCForMultilibs(TargetTriple, Args, InstallDir, false)) {
...
/*static*/ void Generic_GCC::GCCInstallationDetector::CollectLibDirsAndTriples(
  ...
  if (TargetTriple.isAndroid()) {
    ...
    switch (static const char *const X86_64AndroidTriples[] = {"x86_64-linux-android"}; TargetTriple.getArch()) {
    case llvm::Triple::aarch64:
