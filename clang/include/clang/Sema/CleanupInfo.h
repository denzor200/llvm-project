...
public:
  ...
  void setExprNeedsCleanups(bool SideEffects) {
    ...
    CleanupsHaveSideEffects = CleanupsHaveSideEffects || SideEffects;
  }
  ...
  void mergeFrom(CleanupInfo Rhs) {
    ExprNeedsCleanups = ExprNeedsCleanups || Rhs.ExprNeedsCleanups;
    CleanupsHaveSideEffects = CleanupsHaveSideEffects || Rhs.CleanupsHaveSideEffects;
  }
};
